...
interface SurveyUserExperienceProps {
  responses: Record<string, string>;
  setResponse: (id: string, value: string) => void;
  onNext: () => void;
}

export default function SurveyUserExperience({
  responses,
  setResponse,
  onNext,
}: SurveyUserExperienceProps) {
  const { toast } = useToast();
  const section = SURVEY_SECTIONS_ALL.find((s) => s.title === "User Experience")!;
